...
parser.add_argument('--test_dir',default='/data3/limian1/Documents/LPN-main/data/University-Release/test',type=str, help='./test_data')
parser.add_argument('--name', default='resnext50_32x4d', type=str, help='save model path')
parser.add_argument('--pool', default='avg', type=str, help='avg|max')
parser.add_argument('--batchsize', default=10, type=int, help='batchsize')#raw 128
