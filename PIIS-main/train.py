...
parser.add_argument('--name',default='resnext50_32x4d', type=str, help='output model name')
parser.add_argument('--pool',default='avg', type=str, help='pool avg')
parser.add_argument('--data_dir',default='/data3/limian1/Documents/LPN-main/data/University-Release/train',type=str, help='training dir path')
...
parser.add_argument('--use_NAS', default='true', help='use NAS' )
parser.add_argument('--warm_epoch', default=0, type=int, help='the first K epoch that needs warm up')
parser.add_argument('--lr', default=0.001, type=float, help='learning rate')
parser.add_argument('--moving_avg', default=1.0, type=float, help='moving average')
parser.add_argument('--droprate', default=0.5, type=float, help='drop rate')
parser.add_argument('--DA',default='true', help='use Color Data Augmentation' )
parser.add_argument('--resume', action='store_true', help='use resume trainning' )
parser.add_argument('--share', default='true', help='share weight between different view' )
parser.add_argument('--extra_Google', default='true', help='using extra noise Google' )
parser.add_argument('--LPN', default='true', help='use LPN' )
